...
const out = await pipeline([TOPIC],
  (t) => agent(`FIRST-PRINCIPLES DERIVER for ${t.title}. ${t.derive} Write wikis/${t.slug}-derivation.md (math-authoring rules, \\tag{N}). Predict viability. ${SHARED}`, {phase:'Derive'}),
