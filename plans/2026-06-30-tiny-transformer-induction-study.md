...
- **Stretch:** **Rung 2** — mini-GPT-2 (~10M) from-scratch on tiny-shakespeare (the emergence bridge); the **grokking second-circuit sub-study** (modular addition; detailed below); the IOI circuit on GPT-2 small; Phase-5 quantization; the H4/H4b seed-permutation + role-census study at scale.
