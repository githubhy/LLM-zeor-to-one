...
<a id="p-a6-intuition-ii-the-score-is-a-learned-matched-filter-3"></a><!-- para:a6-intuition-ii-the-score-is-a-learned-matched-filter-3 --> **The mapping, procedure by procedure.** Read the score of Equation <!-- ref:A-2 -->[(2)](#eq-2) against that receiver and every step lines up:
