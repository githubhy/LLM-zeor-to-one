...
<a id="p-i1-two-levels-circuits-and-features-1"></a><!-- para:i1-two-levels-circuits-and-features-1 --> The MI literature reads a transformer at two complementary levels, and separating them dissolves most early confusion. This appendix exists because that split was uneven here: a gap analysis of the survey found its MI content strong at the circuit/weight level — Appendix A's QK/OV circuits, composition, induction — and thin on the feature/activation half, the causal-intervention methodology, and the code-specific findings, which is the ordering this appendix follows ([mechanistic-interpretability coverage gaps](../../wikis/mechanistic-interpretability-coverage-gaps.md#sec-1)).
