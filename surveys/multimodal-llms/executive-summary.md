...
<a id="p-0-executive-summary-5"></a><!-- para:0-executive-summary-5 --> Every external citation traces to a source acquired in `download/` and read; benchmark numbers are reproduced from the primary that reports them, and closed-model figures are flagged as third-party-compiled. The full method inventory, derivations, and reference list follow.
