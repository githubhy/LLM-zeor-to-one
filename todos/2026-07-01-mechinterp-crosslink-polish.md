...
redundant/backwards appendix↔main pairs; **12 landed** immediately (the 13th, E.1→Q.5, was
dropped on an anchor mismatch and **added by request 2026-07-02** — all 13 kept links now live).
New links: main-section→Appendix-Q reader-Q&A back-links (§3.1→Q.2, §7.4→Q.6, §12.2→Q.3,
§10.1→Q.8, §8.3→Q.4) + assertion→derivation forward links (§E.1→Q.5, §7.5→E.3, §9.1→A.3,
§2.1→A.4, §2.4→B.2, §5.1→C.1, §10.3→D.3, §Q.4→C.3). Survey now carries 231 valid cross-links;
`/check-survey` green. Residual 14 advisory candidates (cosine ≥ 0.15) triaged
